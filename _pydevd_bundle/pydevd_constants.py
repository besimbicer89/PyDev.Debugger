...
PYDEVD_UNBLOCK_THREADS_TIMEOUT = as_int_in_env('PYDEVD_UNBLOCK_THREADS_TIMEOUT', 10)
...
PYDEVD_INTERRUPT_THREAD_TIMEOUT = as_int_in_env('PYDEVD_INTERRUPT_THREAD_TIMEOUT', 0)
